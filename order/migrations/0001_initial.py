...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('products', '0006_alter_products_ratings'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Delivered', 'Delivered')], default='Processing')),
                ('payment_mode', models.CharField(choices=[('COD', 'Cod'), ('CARD', 'Card'), ('UPI', 'Upi')], default='CARD')),
